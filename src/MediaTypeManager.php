...
/**
 * @file
 * Contains \Drupal\media_entity\MediaTypeManager.
 */
...
class MediaTypeManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/MediaEntity/Type', $namespaces, $module_handler, 'Drupal\media_entity\Annotation\MediaType');
